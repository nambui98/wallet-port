...
const DialogProtectionHistory = ({ children, ...props }: Props) => {
      ...
      <DialogContent className="p-3 md:p-6">
        ...
        <div>
          {protectionContracts?.length === 0 ? (
            ...
            <div className="-mr-6 flex h-full max-h-[200px] flex-col gap-2 overflow-auto pr-6 md:max-h-[300px] 2xl:max-h-[478px] [@media(max-height:500px)]:!max-h-[180px] [@media(max-height:600px)]:max-h-[200px]">
...
export default DialogProtectionHistory
